    ...
    <>
      <div className=" md:min-h-screen relative">
        ...
        <div className="relative pb-10 h-fit">
          ...
          <div className="relative z-10 grid md:grid-cols-[2fr_1fr]">
            {/* content */}
            <div className="mt-10 w-5/6  mx-auto md:mt-20">
              <h1 className="md:text-white font-bold text-3xl text-center md:text-left md:text-2xl md:w-80 md:ml-20">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit
              </h1>
              <p className="text-md text-center mt-10 w-fit md:text-[#F5F5F5] md:w-80 md:ml-20 md:text-left">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                enim ad minim veniam, quis
              </p>
              {/* Buttons */}
              <div className="mt-14 w-fit flex mx-auto md:mt-20 md:mx-0">
                <button
                ...
                <button className="flex items-center bg-gray-700 text-slate-50 rounded w-40 h-12 ml-5">
            ...
            {/* social icons */}
            <div className="hidden md:flex flex-col mr-20 mt-20 ">
              <button className="p-1 rounded text-white justify-items-end mt-5 ">
                <svg
                  width="30"
                  height="30"
                  viewBox="0 0 26 25"
